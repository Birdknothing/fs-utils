...
//定义替换字符串操作，前面两个参数是数组
function findStr(nameOrigin,originurl){
    //省略第四个参数则默认在原文件修改
    //!!!此处原始目录必须已经存在
...
//遍历数组内的元素，是字符串的情形
        ...
        {
            console.log(origStr+' was found in '+absurl);
            //不断修改原来的内容
            // originStr = originStr.replace(regexp,nameToReplace[index]);
            // console.log(absurl+' was found ');
        }
        //所有字符串都被替换完后
